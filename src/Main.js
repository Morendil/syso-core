...
exports.uniroot = function(func) {
	return function(lowerLimit) {
		return function(upperLimit) {
			return function(errorTol) {
				return function(maxIter) {
					return uniroot(func, lowerLimit, upperLimit, errorTol, maxIter);
				}
			}
		}
	}
